...
const FeatureCard: React.FC<FeatureCardProps> = ({ imageSrc, imageAlt, title, year, category, description }) => {
  return (
    <div className="text-gray-800 flex items-start max-md:flex-col max-md:justify-center max-md:items-center max-md:gap-4 p-6 mb-6">
      ...
      <div className="px-2 mt-1 space-y-2">
        ...
        <p className="mb-2">
          <span className="text-white bg-red-400 px-3 rounded-3xl font-extrabold h-11">{year}</span>
          &nbsp; &nbsp; {category}
        </p>
